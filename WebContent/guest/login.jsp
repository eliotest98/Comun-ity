...
<link href="${pageContext.request.contextPath}/styles/login.css"
	rel="stylesheet" />
<link href="${pageContext.request.contextPath}y/styles/navbar.css"
	rel="stylesheet" />
				...
				<form action="/Comun-ity/loginServlet" method="post">
					<div class="mb-3">
						<label for="email" class="form-label">Email</label> <input
							type="email" placeholder="name@example.com" class="form-control"
							name="mailUser" aria-describedby="emailHelp" required>
					</div>
					<div class="mb-3">
						<label for="password" class="form-label">Password</label> <input
							type="password" placeholder="********" class="form-control"
							name="passwordUser" aria-describedby="passwordHelp" required>
					</div>
					<div class="row">
						<div class="col-xxl-8">
