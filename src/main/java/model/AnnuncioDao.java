...
public class AnnuncioDao {
  ...
  private static Document docForDb(Annuncio annuncio) {
    ...
    if (doc == null) {
      doc = new Document("_id", new ObjectId()).append("id", annuncio.getId())
          ...
          .append("incaricato", annuncio.getIncaricato()).append("dataFine", annuncio.getDataFine())
   ...
   *
   * @param incaricato is the email of the ad's appointee.
   * @return a List of ads, not marked as done, accepted from the given appointee.
   */
