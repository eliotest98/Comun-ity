...
public class MailSender {
   ...
   */
  public static void notifyAccreditationReq(Accreditamento accreditamento) throws AddressException,
      MessagingException {
    //TODO
  ...
  private static String createBody1(Accreditamento accreditamento) {
    ...
    text =
        "E' stata sottomessa una nuova richiesta di accreditamento.\n" + "L'utente " + accreditamento
            .getRichiedente() + ", \n" + " ha sottomoesso una richiesta di accreditamento al fine di essere riconosciuto dal sistema come " + accreditamento
                .getAbilitazione() + ".";
