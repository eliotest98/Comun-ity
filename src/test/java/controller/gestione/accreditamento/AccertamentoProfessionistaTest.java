...
public class AccertamentoProfessionistaTest {
  ...
  AccertamentoProfessionistaServlet servletMock = Mockito.mock(AccertamentoProfessionistaServlet.class);
  GestioneAccreditamentoService accrServiceMock = Mockito.mock(GestioneAccreditamentoServiceImpl.class);
